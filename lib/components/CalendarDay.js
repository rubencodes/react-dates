...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _getPhrase = __webpack_require__(8);
	  ...
	  _createClass(CalendarDay, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        var formattedDate = String((0, _format2['default'])(day, 'dddd')) + ', ' + String((0, _format2['default'])(day, 'LL'));
	        ...
	        return _react2['default'].createElement('td', { className: className, style: daySizeStyles }, _react2['default'].createElement('button', {
	          ...
	          tabIndex: tabIndex
	        }, renderDay ? renderDay(day) : (0, _format2['default'])(day, 'D')));
	      }
